...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'Qian233@1qv4cm.onmicrosoft.com',
  ...
  protectedRoutes: ['/萌白', '/🥟 Some test files/Protected route'],
